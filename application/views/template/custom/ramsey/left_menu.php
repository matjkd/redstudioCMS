<div class="leftmenu">
<ul>
	<li><a href="<?=base_url()?>welcome/main/home"><img width="160px" height="12px" src="<?=base_url()?>images/template/custom/ramsey/menu/home.png"/></a></li>
	<li><a href="<?=base_url()?>welcome/main/services"><img width="160px" height="12px"  src="<?=base_url()?>images/template/custom/ramsey/menu/services.png"/></a></li>
	<li><a href="<?=base_url()?>welcome/main/profile"><img width="160px" height="12px"  src="<?=base_url()?>images/template/custom/ramsey/menu/profile.png"/></a></li>
